...
`]))),Ne=L.Z,Ge=function(Z){var J=Z.schema,w=Z.required,X=Z.prefixClassNames,q=Z.labelColon,le=!!q;return(0,m.jsxs)(m.Fragment,{children:[w&&(0,m.jsx)("span",{className:Ne(X("item-mark"),Le),children:"*"}),(0,m.jsx)("span",{className:Ne(X("item-title"),_e),children:J.title}),!!J.titleDescription&&(0,m.jsx)(V.Z,{placement:"top",trigger:"hover",content:J.titleDescription,children:(0,m.jsx)(W.Z,{className:Ne(X("item-title-tooltip"),We),style:{marginRight:le?4:void 0}})}),le&&(0,m.jsx)("span",{className:Ne(X("item-colon")),children:q})]})},Ye=function(Z){var J=Z.body,w=Z.schema,X=Z.validator,q=Z.required,le=Z.disabled,ce=Z.readonly,me=Z.userCtx,Ie=Z.prefixClassNames,Pe=l(),Oe=Pe.labelWidth,be=Pe.labelColon,Se=Pe.labelGap,Me=Pe.labelRender,Re=Pe.locale,je=Me||Ge,$e={schema:w,required:q,disabled:le,readonly:ce,userCtx:me,prefixClassNames:Ie,labelWidth:Oe,labelColon:be,labelGap:Se,locale:Re};return(0,m.jsxs)("div",{className:Ne(Ie("item-layout-horizontal")),children:[(0,m.jsxs)("div",{className:Ne(Ie("item-main"),Ee),children:[(0,m.jsx)("div",{className:Ne(Ie("item-header"),Ce),style:{flexBasis:Oe,marginRight:Se},children:je($e)}),(0,m.jsx)("div",{className:Ne(Ie("item-body"),Ae),children:J})]}),(0,m.jsxs)("div",{className:Ne(Ie("item-footer"),Ue),style:{paddingLeft:A.hj(Oe)?Oe+Se:0},children:[X.status==="error"&&!!X.message&&(0,m.jsx)("div",{className:Ne(Ie("item-error-msg"),Ke),children:X.message}),X.status==="warning"&&!!X.message&&(0,m.jsx)("div",{className:Ne(Ie("item-warning-msg"),Ze),children:X.message}),!!w.description&&(0,m.jsx)("div",{className:Ne(Ie("item-description"),Fe),children:w.description})]})]})},Je=Ye,Be,He,hn,nn,vn,tn,In,en,An=(0,H.H)(Be||(Be=z()([`
  margin-bottom: 8px;
`]))),an=(0,H.H)(He||(He=z()([`
  word-break: break-all;
`]))),jn=(0,H.H)(hn||(hn=z()([`
